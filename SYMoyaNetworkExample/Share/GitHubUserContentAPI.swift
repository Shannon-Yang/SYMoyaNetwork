...
//import Moya
//
//let gitHubUserContentProvider = SYMoyaProvider<GitHubUserContent>(plugins: [NetworkLoggerPlugin(configuration: .init(logOptions: .verbose))])
//
...
//        }
//    }
//    public var method: SYMoyaProvider.Method {
//        switch self {
