...
public class StringResponseSerializer: ResponseSerializer {
    ...
    public func serialize(result: SYMoyaNetworkResult) -> SYMoyaNetworkDataResponse<SerializedObject> {
        result.serializerStringDataResponse(atKeyPath: atKeyPath)
    }
}

extension ResponseSerializer where Self == StringResponseSerializer {
    /// Default serializer object
    public static var defaultStringSerializer: StringResponseSerializer {
    ...
    public static func string(atKeyPath: String?) -> StringResponseSerializer {
        StringResponseSerializer(atKeyPath: atKeyPath)
    }
}
