...
public class ImageResponseSerializer: ResponseSerializer {
    ...
    public func serialize(result: SYMoyaNetworkResult) -> SYMoyaNetworkDataResponse<SerializedObject> {
        result.serializerImageDataResponse()
    }
}

extension ResponseSerializer where Self == ImageResponseSerializer {
    /// Default serializer object
    public static var defaultImageSerializer: ImageResponseSerializer {
    ...
    public static func image() -> ImageResponseSerializer {
        ImageResponseSerializer()
    }
}
