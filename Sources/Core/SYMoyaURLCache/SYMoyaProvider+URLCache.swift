...
extension SYMoyaProvider {
    ...
    /// The response data of the newline URL will be cached through the http protocol when the NetworkCacheType type is urlRequestCache
    /// - Parameters:
    ...
    ///   - urlCacheInfo: URL cache information, such as ignoreServer, maxAge, autoClearCache and other information
...
public extension SYMoyaProvider {
    ...
    /// Clear URL cache data based on URLRequest and urlCacheInfo
    /// - Parameters:
    ///   - request: URL request object
    ///   - urlCacheInfo: URL cache information, such as ignoreServer, maxAge, autoClearCache and other information
    func clearURLCache(_ request: URLRequest, urlCacheInfo: NetworkCacheType.URLCacheInfo) {
        let urlCache = self.urlCache.urlCache
    ...
    /// Clear URL cache data based on target and urlCacheInfo
    /// - Parameters:
    ///   - target: The protocol used to define the specifications necessary for a `MoyaProvider`.
    ///   - urlCacheInfo: URL cache information, such as ignoreServer, maxAge, autoClearCache and other information
    func clearCache(_ target: Target, urlCacheInfo: NetworkCacheType.URLCacheInfo) {
