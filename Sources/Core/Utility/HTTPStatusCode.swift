...
extension HTTPStatusCode {
    ...
    public var responseStatus: HTTPStatusCode.Class {
        return Class(code: rawValue)
    }
    ...
    var reasonPhrase: String {
        return defaultReasonPhrase(forCode: rawValue)
    }
...
extension HTTPStatusCode {
    ...
    func defaultReasonPhrase(forCode code: Int) -> String {
        switch self {
