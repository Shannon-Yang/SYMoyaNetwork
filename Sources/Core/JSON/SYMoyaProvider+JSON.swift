...
extension SYMoyaProvider {
    ...
    /// Retrieve cached data from disk cache and parses the retrieved data into an object that is `JSON`.
    ///
    /// - Parameters:
    ///   - target: The protocol used to define the specifications necessary for a `SYMoyaProvider`.
    ///   - serializer: A `ResponseSerializer` that decodes the response data as a `JSON`.
    ...
    /// Retrieve cached data from memory cache and parses the retrieved data into an object that is `JSON`.
    ///
    /// - Parameters:
    ///   - target: The protocol used to define the specifications necessary for a `SYMoyaProvider`.
    ///   - serializer: A `ResponseSerializer` that decodes the response data as a `JSON`.
